...
def efficient_capsnet_graph(input_shape, if_solo=False):
    """
    ...
    x = tf.keras.layers.Conv2D(32,5,activation="relu", padding='valid', kernel_initializer='he_normal', use_bias=True)(inputs)
    x = tf.keras.layers.BatchNormalization()(x)
    x = tf.keras.layers.Conv2D(64,3, activation='relu', padding='valid', kernel_initializer='he_normal', use_bias=True)(x)
    x = tf.keras.layers.BatchNormalization()(x)
    x = tf.keras.layers.Conv2D(96, 3, activation='relu', padding='valid', kernel_initializer='he_normal',use_bias=True)(x)
    x = tf.keras.layers.BatchNormalization()(x)
    x = tf.keras.layers.Conv2D(128,3, activation='relu', padding='valid', kernel_initializer='he_normal', use_bias=True)(x)
    x = tf.keras.layers.BatchNormalization()(x)
